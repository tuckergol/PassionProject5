...
def get_random_country():
    current_country = random.choice(country_data)
    return current_country

#testing
# if __name__ == "__main__":
#     initGeoguesser() i am not sure if u can finish the ntire thing within 15 mins but plz coinnect it to frontend plz
